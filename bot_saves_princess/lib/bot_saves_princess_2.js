...
function BotSavesPrincess( input ) {
  ...
  this.bot.shouldMoveRight = (this.princess.x > this.bot.x);

  this.bot.shouldMoveDown = (this.princess.y > this.bot.y);
...
, 'nextMove' : function() {
    if ( this.bot.shouldMoveLeft || this.bot.shouldMoveRight ) {
      return this.bot.moveLeftOrRight;
    } 

    if ( this.bot.shouldMoveUp || this.bot.shouldMoveDown ) {
      return this.bot.moveUpOrDown;
    }
  }
